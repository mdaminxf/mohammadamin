    ...
    <style>
        .navlogo{
            width: 300px;
				...
				border-radius: 40% 60% 51% 49% / 60% 61% 39% 40%  ;
			}
			@keyframes animate{
                0%{border-radius: 40% 60% 51% 49% / 60% 61% 39% 40% ;}
                30%{border-radius: 43% 57% 45% 55% / 62% 67% 33% 38% ;}
                50%{border-radius:52% 48% 42% 58% / 62% 67% 33% 38% ;}
                0%{border-radius: 40% 60% 51% 49% / 60% 61% 39% 40% ;}
			}
...
<body>
    ...
    <header class="header" id="header">
        <nav class="nav container">
            <a href="#" class="nav__logo">MohammadAmin</a>
    ...
    <main class="main">
            ...
            <div class="home__container container grid">
                <div class="home__content grid">
                    <div class="home__social">
                        <a href="https://www.linkedin.com/" aria-label="home__social-icon" target="_blank"
                            class="home__social-icon">
                            <i class="uil uil-linkedin-alt"></i>
                        </a>
                        <a href="https://dribbble.com/" aria-label="home__social-icon" target="_blank"
                            class="home__social-icon">
                            <i class="uil uil-dribbble"></i>
                        </a>
                        <a href="https://github.com/" aria-label="home__social-icon" target="_blank"
                            class="home__social-icon">
                    ...
                    <div class="home__img">
                        ...
                        <div class="navlogo" style="overflow: hidden;">
                           <img class="home__blob-img" style="height: 100%;width: 100%;" src="./assets/img/perfil.png" >
                    </div> 
                    </div>
                    <div class="home__data">
                        <h1 class="home__title">Hi, I'am MohammadAmin</h1>
                        <h3 class="home__subtitle">Frontend Developer</h3>
                        <p class="home__discription">High level experience in web design and development knowledge,
            ...
            <div class="about__container container grid">
                ...
                <div class="about__data">
                    ...
                    <div class="about__buttons">
                        <a href="/assets/pdf/MohammadAmin-Cv.pdf" download class="button button--flex">
        ...
        <section class="skills section" id="skills">
            ...
            <div class="skills__container container grid">
                <!--==================== SKILLS 1 ====================-->
                <div class="skills__content skills__open"id="skill" >
                    <div class="skills__header"id="skill1">
                ...
                <!--==================== SKILLS 2 ====================-->
                <div class="skills__content skills__open" id="skill2">
                    ...
                    <div class="qualification__content" data-content id="work">
                        ...
                        <div class="qualification__data">
                            ...
                            <div>
                                ...
                                <span class="qualification__subtitle">Apple Inc - Span</span>
                                <div class="qualification__calender">
                                    <i class="uil uil-calendar-alt"></i>
                                    2018 - 2020
                                </div>
                        ...
                        <div class="qualification__data">
                            <div>
                                ...
                                <span class="qualification__subtitle">Figma - Span</span>
                                <div class="qualification__calender">
                                    <i class="uil uil-calendar-alt"></i>
                                    2017 - 2019
                                </div>
                ...
                <div>
                    ...
                    <div class="contact__information">
                        ...
                        <div>
                            ...
                            <span class="contact__subtitle">MohammadAmin@email.com</span>
                        </div>
                    </div>
                    <div class="contact__information">
    ...
    <footer class="footer">
        <div class="footer__bg">
            <div class="footer__container container grid">
                <div>
                    <h1 class="footer__title">MohammadAmin</h1>
                ...
                <div class="footer__socials">
                    <a href="https://www.facebook.com/" aria-label="footer__social" target="_blank"
                        class="footer__social">
                        <i class="uil uil-facebook-f"></i>
                    </a>
                    <a href="https://www.instagram.com/" aria-label="footer__social" target="_blank"
                        class="footer__social">
